...
/*!
 This structure saves the location vector, the (Choleski decomposition
...
template <typename T>
T *SingletonRnd<T>::_singleton = NULL;
...
/*!
  \param freq the empirical density function in which the random draw is done.
